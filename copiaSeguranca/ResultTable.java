...
public class ResultTable {
    ...
    public void runNaiveBayes(File dataset, FileWriter table, FileWriter fields) throws IOException{
        ...
        try{
            ...
            System.out.println("Tratando exceção para o arquivo: " + dataset.toString());
        }
    }
    ...
    public static void main(String[] args) throws IOException, Exception {
        ...
        //Samuel 
        File directory = new File("/home/samuel/Documentos/BCC/Projeto/arquivos_teste/saida/arff2");
        //Ricardo
        ...
        new ResultTable(AlgorithmsOptions.NaiveBayes).createResultTable(datasets,output,fields);
    }
}
