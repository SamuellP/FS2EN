...
public final class Cluster {
    ...
    private double sumDistances; // Para não precisar percorrer todos os vetorem sempre que o centroide for recalculado
    ...
    Cluster(){
        ...
        this.sumDistances = 0; // Armazena a soma dos valores ROC de cada vetor
        this.qtdVectors = 0;
    }
